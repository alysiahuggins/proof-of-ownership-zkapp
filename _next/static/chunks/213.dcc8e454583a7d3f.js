...
var stub = __webpack_require__(6207);
var parse = __webpack_require__(3640);
var tracking = __webpack_require__(6721);
...
/* harmony export */   "W": function() { return /* binding */ candidates; }
/* harmony export */ });
...
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "Cv": function() { return /* binding */ getNFTHolders; },
/* harmony export */   "ZL": function() { return /* binding */ setNFTHolder; }
/* harmony export */ });
/* unused harmony exports resetNFTHolders, getMockNFTHolders, setMockNFTHolder */
/* harmony import */ var local_storage__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(9427);
...
function getNFTHolders() {
    ...
    let holders = local_storage__WEBPACK_IMPORTED_MODULE_0__.get('nft_holders') | [];
    if (!holders) {
        local_storage__WEBPACK_IMPORTED_MODULE_0__.set('nft_holders', nft_holders);
        return nft_holders;
    }
    else {
        holders = local_storage__WEBPACK_IMPORTED_MODULE_0__.get('nft_holders');
        return holders;
    }
}
...
function setNFTHolder(holder) {
    ...
    local_storage__WEBPACK_IMPORTED_MODULE_0__.set('nft_holders', temp_nft_holders);
    return newLength;
}
...
//# sourceMappingURL=nft_holders.js.map
...
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "CandidateWitness": function() { return /* binding */ CandidateWitness; },
/* harmony export */   "NFTHolder": function() { return /* binding */ NFTHolder; },
/* harmony export */   "NFTHolderWitness": function() { return /* binding */ NFTHolderWitness; },
/* harmony export */   "Own": function() { return /* binding */ Own; },
/* harmony export */   "createCandidatesMerkleTree": function() { return /* binding */ createCandidatesMerkleTree; },
/* harmony export */   "createNFTHoldersMerkleTree": function() { return /* binding */ createNFTHoldersMerkleTree; }
/* harmony export */ });
/* harmony import */ var snarkyjs__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(6400);
/* harmony import */ var _nft_holders_nft_holders_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(5961);
/* harmony import */ var _nft_holders_candidates__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(1236);
...
const nft_holders = (0,_nft_holders_nft_holders_js__WEBPACK_IMPORTED_MODULE_1__/* .getNFTHolders */ .Cv)();
...
let nftHoldersTree = new snarkyjs__WEBPACK_IMPORTED_MODULE_0__/* .MerkleTree */ .MV(10);
let candidatesTree = new snarkyjs__WEBPACK_IMPORTED_MODULE_0__/* .MerkleTree */ .MV(10);
let validatedNFTHoldersTree = new snarkyjs__WEBPACK_IMPORTED_MODULE_0__/* .MerkleTree */ .MV(10);
class NFTHolderWitness extends (0,snarkyjs__WEBPACK_IMPORTED_MODULE_0__/* .MerkleWitness */ .Pj)(10) {
}
class CandidateWitness extends (0,snarkyjs__WEBPACK_IMPORTED_MODULE_0__/* .MerkleWitness */ .Pj)(10) {
}
class NFTHolder extends snarkyjs__WEBPACK_IMPORTED_MODULE_0__/* .CircuitValue */ .wA {
    constructor(address) {
        super(address);
...
class Candidate extends snarkyjs__WEBPACK_IMPORTED_MODULE_0__/* .CircuitValue */ .wA {
...
], Candidate.prototype, "points", void 0);
function createNFTHoldersMerkleTree() {
    //generates the merkle tree from the list of nft holders
    for (let i in nft_holders) {
        let thisHolder = new NFTHolder(snarkyjs__WEBPACK_IMPORTED_MODULE_0__/* .CircuitString.fromString */ ._G.fromString(nft_holders[i]));
        nftHoldersTree.setLeaf(BigInt(i), thisHolder.hash());
    }
    // now that we got our accounts set up, we need the commitment to deploy our contract!
    return nftHoldersTree;
}
function createCandidatesMerkleTree() {
    //generates the merkle tree from the list of nft holders
    for (let i in _nft_holders_candidates__WEBPACK_IMPORTED_MODULE_2__/* .candidates */ .W) {
        let thisCandidate = new Candidate(snarkyjs__WEBPACK_IMPORTED_MODULE_0__/* .CircuitString.fromString */ ._G.fromString(_nft_holders_candidates__WEBPACK_IMPORTED_MODULE_2__/* .candidates */ .W[i]), snarkyjs__WEBPACK_IMPORTED_MODULE_0__/* .UInt32.from */ .xH.from(0));
        candidatesTree.setLeaf(BigInt(i), thisCandidate.hash());
    }
    // now that we got our accounts set up, we need the commitment to deploy our contract!
    return candidatesTree;
}
class Own extends snarkyjs__WEBPACK_IMPORTED_MODULE_0__/* .SmartContract */ .C3 {
    constructor() {
        super(...arguments);
        this.commitmentNFTHolders = (0,snarkyjs__WEBPACK_IMPORTED_MODULE_0__/* .State */ .ZM)();
        this.validatedNFTHoldersTotal = (0,snarkyjs__WEBPACK_IMPORTED_MODULE_0__/* .State */ .ZM)();
        this.commitmentValidatedNFTHolders = (0,snarkyjs__WEBPACK_IMPORTED_MODULE_0__/* .State */ .ZM)();
        this.commitmentCandidates = (0,snarkyjs__WEBPACK_IMPORTED_MODULE_0__/* .State */ .ZM)();
    }
    deploy(args) {
        super.deploy(args);
        this.setPermissions({
    ...
    init() {
        ...
        this.validatedNFTHoldersTotal.set((0,snarkyjs__WEBPACK_IMPORTED_MODULE_0__/* .Field */ .gN)(0));
        this.commitmentCandidates.set(createCandidatesMerkleTree().getRoot());
    }
    validateNFTHolder(nftHolder, path) {
        ...
        path.calculateRoot(snarkyjs__WEBPACK_IMPORTED_MODULE_0__/* .Poseidon.hash */ .jm.hash(nftHolder.toFields())).assertEquals(commitment);
    }
    validateAndStoreNFTHolder(nftHolder, path, minaAddress) {
        let commitment = this.commitmentNFTHolders.get();
        this.commitmentNFTHolders.assertEquals(commitment);
        // we check that the response is the same as the hash of the answer at that path
        path.calculateRoot(snarkyjs__WEBPACK_IMPORTED_MODULE_0__/* .Poseidon.hash */ .jm.hash(nftHolder.toFields())).assertEquals(commitment);
    ...
    updateNFTHolders(nftHolder, path) {
        let commitment = this.commitmentNFTHolders.get();
        this.commitmentNFTHolders.assertEquals(commitment);
        ...
        (0,_nft_holders_nft_holders_js__WEBPACK_IMPORTED_MODULE_1__/* .setNFTHolder */ .ZL)(nftHolder.address.toString());
    }
}
__decorate([
    (0,snarkyjs__WEBPACK_IMPORTED_MODULE_0__/* .state */ .SB)(snarkyjs__WEBPACK_IMPORTED_MODULE_0__/* .Field */ .gN),
    __metadata("design:type", Object)
], Own.prototype, "commitmentNFTHolders", void 0);
__decorate([
    (0,snarkyjs__WEBPACK_IMPORTED_MODULE_0__/* .state */ .SB)(snarkyjs__WEBPACK_IMPORTED_MODULE_0__/* .Field */ .gN),
    __metadata("design:type", Object)
], Own.prototype, "validatedNFTHoldersTotal", void 0);
__decorate([
    (0,snarkyjs__WEBPACK_IMPORTED_MODULE_0__/* .state */ .SB)(snarkyjs__WEBPACK_IMPORTED_MODULE_0__/* .Field */ .gN),
    __metadata("design:type", Object)
], Own.prototype, "commitmentValidatedNFTHolders", void 0);
__decorate([
    (0,snarkyjs__WEBPACK_IMPORTED_MODULE_0__/* .state */ .SB)(snarkyjs__WEBPACK_IMPORTED_MODULE_0__/* .Field */ .gN),
    __metadata("design:type", Object)
], Own.prototype, "commitmentCandidates", void 0);
__decorate([
    snarkyjs__WEBPACK_IMPORTED_MODULE_0__/* .method */ .UD,
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [NFTHolder, NFTHolderWitness]),
    __metadata("design:returntype", void 0)
], Own.prototype, "validateNFTHolder", null);
__decorate([
    snarkyjs__WEBPACK_IMPORTED_MODULE_0__/* .method */ .UD,
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [NFTHolder, NFTHolderWitness, NFTHolder]),
    __metadata("design:returntype", void 0)
], Own.prototype, "validateAndStoreNFTHolder", null);
__decorate([
    snarkyjs__WEBPACK_IMPORTED_MODULE_0__/* .method */ .UD,
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [NFTHolder, NFTHolderWitness]),
    __metadata("design:returntype", void 0)
], Own.prototype, "verifyAlreadyValidated", null);
__decorate([
    snarkyjs__WEBPACK_IMPORTED_MODULE_0__/* .method */ .UD,
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Candidate, CandidateWitness]),
    __metadata("design:returntype", void 0)
], Own.prototype, "voteForCandidate", null);
__decorate([
    snarkyjs__WEBPACK_IMPORTED_MODULE_0__/* .method */ .UD,
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [NFTHolder, NFTHolderWitness]),
    __metadata("design:returntype", void 0)
], Own.prototype, "updateNFTHolders", null);
