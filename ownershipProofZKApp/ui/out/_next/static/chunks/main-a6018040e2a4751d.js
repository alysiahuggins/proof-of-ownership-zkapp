...
const basePath = "/proof-of-ownership-zkapp" || 0;
...
const ReactDOM =  true ? __webpack_require__(745) : 0;
...
function AppContainer(param) {
    ...
    return /*#__PURE__*/ _react.default.createElement(Container, {
        ...
        value: {"deviceSizes":[640,750,828,1080,1200,1920,2048,3840],"imageSizes":[16,32,48,64,96,128,256,384],"path":"/proof-of-ownership-zkapp/_next/image","loader":"default","dangerouslyAllowSVG":false,"unoptimized":true}
    }, children))));
}
...
class Router {
   ...
   */ prefetch(url) {
    ...
    constructor(pathname1, query1, as1, { initialProps , pageLoader , App , wrapApp , Component , err , subscription , isFallback , locale , locales , defaultLocale , domainLocales , isPreview  }){
        ...
        this.basePath = "/proof-of-ownership-zkapp" || 0;
