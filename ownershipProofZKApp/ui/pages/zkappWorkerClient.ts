...
export default class ZkappWorkerClient {
  ...
  async createLogInTransaction(response: string, holderPosition: string) {
    return await this._call('createLogInTransaction', {response: response, holderPosition: holderPosition});
  }
